...
public class FacilityUtilityCode extends BaseClass {

	public FacilityUtilityCode() {
		super(getDriver());
		 PageFactory.initElements(getDriver(), this);
	}
	WebDriver driver = BaseClass.getDriver();
	//@FindBy(xpath = "//input[contains(@id,'instance-input')]")//div[@id='select2-drop']/div/input")
    ...
    public void fillDropdownField(WebElement element, String value) throws InterruptedException {
        element.click();
        Thread.sleep(1000);
        WebElement enterInput = getElement(element);
    ...
    public WebElement getElement(WebElement element) {
		String customField = null;
		        ...
		        // Regular expression to extract 'customfield_11372'
		        String regex = "customfield_\\d+";
		        Pattern pattern = Pattern.compile(regex);
		        Matcher matcher = pattern.matcher(input);
		        
		        if (matcher.find()) {
		             customField = matcher.group();
		            //System.out.println("Extracted Custom Field: " + customField);
		        } else {
		            System.out.println("No match found.");
		        }
		  
	    String dynamicId = "react-select-" + customField + "-instance-input";
    ...
    public void subtask() throws InterruptedException {
		for (int i = 1; i <= subtaskList.size(); i++) {
			...
			WebElement element = driver.findElement(By.xpath("//tr[1]/td[@class='issuekey']/a"));
